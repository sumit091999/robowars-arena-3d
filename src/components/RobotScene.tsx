  ...
  return (
    <group ref={group} position={[0, -0.4, 0]}>
      ...
      <mesh castShadow position={[-0.3, 0.7, 0]} rotation={[0, 0, 0.2]}>
        ...
        <meshStandardMaterial color="#e11d48" metalness={0.8} roughness={0.25} emissive="#e11d48" emissiveIntensity={0.15} />
      </mesh>
      {/* Spinning blade */}
      <mesh ref={blade} position={[1.3, 0.45, 0]} castShadow>
        <cylinderGeometry args={[0.6, 0.6, 0.08, 6]} />
        <meshStandardMaterial color="#f43f5e" metalness={1} roughness={0.1} emissive="#f43f5e" emissiveIntensity={0.4} />
      </mesh>
      {/* Wheels */}
      {[
        [-0.8, 0, 0.75],
  ...
  return (
    <Canvas shadows camera={{ position: [4, 2.5, 5], fov: 45 }} dpr={[1, 2]}>
      <Suspense fallback={null}>
        ...
        <spotLight position={[5, 8, 5]} angle={0.4} penumbra={1} intensity={2} color="#f43f5e" castShadow />
        <spotLight position={[-5, 5, -5]} angle={0.5} penumbra={1} intensity={1.5} color="#06b6d4" />
